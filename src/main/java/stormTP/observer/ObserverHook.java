 ...
 *
 */
public class ObserverHook  extends BaseTaskHook implements Serializable{

	private static final long serialVersionUID = 8331951328870007552L;
	...
	public void emit(EmitInfo info) {
		...
		StreamEmiter st = new StreamEmiter(9003, "226.0.0.198");
