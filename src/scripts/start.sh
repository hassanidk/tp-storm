...
"
screen -S zooknimbus -X stuff "ssh -i STORM/pedabdcloud -X ubuntu@192.168.76.173
"
...
"
screen -S UI -X stuff "ssh -i STORM/pedabdcloud -X ubuntu@192.168.76.173
"
...
"
screen -S Supervisor -X stuff "ssh -i STORM/pedabdcloud -X ubuntu@192.168.76.173
"
...
"
screen -S Monitoring -X stuff "ssh -i STORM/pedabdcloud -X ubuntu@192.168.76.173
"
